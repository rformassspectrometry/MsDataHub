...
##' human serum samples (the same pool being measured). The samples
##' were analyzed by ultra high-performance liquid chromatography
##' (UHPLC; Agilent 1290) coupled to a Q-TOF mass spectrometer
##' (TripleTOF 5600+ AB Sciex). The chromatographic separation was
